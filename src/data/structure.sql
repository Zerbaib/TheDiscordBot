...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS id INT AUTO_INCREMENT PRIMARY KEY;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS guildID INT(30);
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS avatarURL text;
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS nickname text;
ALTER TABLE profiles MODIFY COLUMN guildID BIGINT UNSIGNED;